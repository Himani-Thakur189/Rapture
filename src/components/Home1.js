        ...
        return (
            <div>
                ...
                <div className="tourPackages">
                    ...
                    <div class="grid">
                        <div>
                            <img className='item1' src={tent} height='100px' width='100px'></img>
                            <p className='headText'>Egab Picnic Camping</p>
                            <em className='em1'>Egab Picnic Camping portable waterProof Tent(2 Person)
                            </em>
                            <div id='price'>$90</div>
                            <button className='addButton' onClick={this.onAdd}>{this.state.add}</button>
                        </div>
                        <div>
                            <img className='item1' src={gloves} height='100px' width='100px'></img>
                            <p className='headText'>Claz Trekking Gloves</p>
                            <em className='em2'>ForClaz Trekking Gloves, WaterProof ,Warm ,(Bikers)
                            </em>
                            <div id='price'>$30</div>
                            <button className='addButton' onClick={this.onAdd}>{this.state.add}</button>
                        </div>
                        <div>
                            <img className='item1' src={helmet} height='100px' width='100px'></img>
                            <p className='headText'>Benz Ultra Power</p>
                            <em className='em3'>BenZ Ultra Power Helmet, Open Face Helmet (Black Glossy)
                            </em>
                            <div id='price'>$90</div>
                            <button className='addButton' onClick={this.onAdd}>{this.state.add}</button>
                        </div>
                        <div>
                            <img className='item1' src={camera} height='100px' width='100px'></img>
                            <p className='headText'>Sony Digital Camera</p>
                            <em className='em4'>Sony Alpha Microless Digital Camera with 70mm lens
                            </em>
                            <div id='price'>$150</div>
                            <button className='addButton' onClick={this.onAdd}>{this.state.add}</button>
                        </div>
                        <div>
                            <img className='item1' src={jacket} height='100px' width='100px'></img>
                            <p className='headText'>Moutain Hardwear</p>
                            <em className='em5'>Moutain Hardwear Absolute zero Dry parks Q
                            </em>
                            <div id='price'>$60</div>
                            <button className='addButton' onClick={this.onAdd}>{this.state.add}</button>
                        </div>
                    </div>
                    {this.state.click ? <div className='addAlert'>
                        <span className="close" onClick={this.onAddItem1}>&times;</span>
                        <p>Item Added to Cart $90</p>
                    </div> : null}
